...
"")
        ...
        self.leftMenuContainer.setMinimumSize(QtCore.QSize(200, 400))
        self.leftMenuContainer.setMaximumSize(QtCore.QSize(59, 16777215))
        ...
        self.homeBtn.setMinimumSize(QtCore.QSize(0, 60))
        self.homeBtn.setStyleSheet("background-color: #1f232a")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/icons/home.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.dataBtn.setIconSize(QtCore.QSize(35, 35))
        self.dataBtn.setCheckable(False)
        ...
        self.reportBtn.setIconSize(QtCore.QSize(35, 35))
        ...
        self.closeCenterMenuBtn.setIconSize(QtCore.QSize(30, 30))
        ...
        self.headerContiner.setMinimumSize(QtCore.QSize(0, 60))
        ...
        self.moreMenuBtn.setMinimumSize(QtCore.QSize(34, 40))
        self.moreMenuBtn.setMaximumSize(QtCore.QSize(44, 40))
        self.moreMenuBtn.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/map-pin.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.moreMenuBtn.setIcon(icon8)
        self.moreMenuBtn.setIconSize(QtCore.QSize(80, 80))
        ...
        font.setBold(True)
        font.setWeight(75)
        self.profieMenuBtn.setFont(font)
        ...
        self.profieMenuBtn.setIconSize(QtCore.QSize(24, 24))
...
"background-color: rgb(0, 85, 0);")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(0, 360, 499, 60))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(10, 130, 499, 13))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_13)
        self.pushButton_4.setGeometry(QtCore.QRect(10, 170, 499, 13))
        ...
        self.closeRightMenuBtn.setIconSize(QtCore.QSize(30, 30))
        ...
        self.data_x = QtWidgets.QLineEdit(self.frame_12)
        self.data_x.setStyleSheet("")
        self.data_x.setObjectName("data_x")
        self.verticalLayout_22.addWidget(self.data_x)
        self.data_y = QtWidgets.QLineEdit(self.frame_12)
        self.data_y.setObjectName("data_y")
        self.verticalLayout_22.addWidget(self.data_y)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Start Button"))
        self.pushButton_2.setText(_translate("MainWindow", "Stop Button"))
        self.pushButton_3.setText(_translate("MainWindow", "Manual/Automatic"))
